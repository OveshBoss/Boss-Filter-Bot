...
PICS = (environ.get('PICS', 'https://graph.org/file/e2802023c4679a87f28b9-c6a379e6b866d9e1b0.jpg https://graph.org/file/d49d8e3444a2c4625bf8a-8f400c308313387d22.jpg')).split()  # Sample pic
...
# ============================
DATABASE_URI = environ.get('DATABASE_URI', "mongodb+srv://OnlyBoss:OveshBoss@cluster0.dtrrfnm.mongodb.net/?appName=Cluster0")  # MongoDB URI for the database
...
DATABASE_URI2 = environ.get('DATABASE_URI2', "mongodb+srv://bilewacu_db_user:xKdujDsPriLDNQfV@cluster0.o5jnidb.mongodb.net/?appName=Cluster0")  # MongoDB URI for the second database (if MULTIPLE_DB is True)
# ============================
